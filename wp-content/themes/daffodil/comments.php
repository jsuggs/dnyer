...
<?php if ($comments) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="commentind<?php echo $oddcomment; ?>" id="comment-<?php comment_ID() ?>">
			<div class="commentindheader">
			<div class="avatarwrapper">
				<?php echo get_avatar( $comment, 32 ); ?><span class="avataroverlay">&nbsp;</span>
			</div>
			...
			<?php endif; ?>
			<br />
			<small class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('m/d/Y') ?> at <?php comment_time() ?></a><?php edit_comment_link('Edit',' | ',''); ?></small>
			</div>
			<div class="commentindtext">
			<?php comment_text() ?>
			</div>
		</li>
...
<div><input name="submit" type="submit" id="submit" tabindex="5" value="Submit" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
